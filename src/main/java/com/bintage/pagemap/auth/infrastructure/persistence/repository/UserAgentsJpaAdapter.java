...
public class UserAgentsJpaAdapter implements UserAgents {
    ...
    @Override
    public void markAsSignedIn(UserAgent signedUserAgent) {
    ...
    @Override
    public void markAsSignedOut(UserAgent userAgent) {
    ...
    @Override
    public void registerUserAgent(UserAgent newUserAgent) {
