...
import com.bintage.pagetree.auth.application.AuthenticationResponse;
...
public class JwtBearerAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        var requestUserAgentInfo = new Auth.RequestUserAgentInfo(extracted.type(), extracted.os(), extracted.device(), extracted.application());

        var authenticateResponse = auth.authenticate(tokenId.get(), requestUserAgentInfo);
