...
import com.bintage.pagetree.auth.application.SignInResponse;
import com.bintage.pagetree.auth.infrastructure.external.oauth2.client.OAuth2AuthenticatedUser;
...
public class OAuth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        auth.signUpIfFirst(accountId, tokenAttribute.getOAuth2ProviderName(), tokenAttribute.getMemberIdentifier());
        var tokens = auth.signIn(accountId, userAgentId);
