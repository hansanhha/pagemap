...
import com.bintage.pagetree.auth.infrastructure.persistence.repository.OAuth2AuthorizationRequestEntityRepository;
...
public class OAuth2AuthorizationRequestService implements AuthorizationRequestRepository<OAuth2AuthorizationRequest> {
    ...
    public void saveAuthorizationRequest(OAuth2AuthorizationRequest authorizationRequest, HttpServletRequest request, HttpServletResponse response) {
        ...
        var userAgentId = auth.saveUserAgent(userAgentInfo.type(), userAgentInfo.os(), userAgentInfo.device(), userAgentInfo.application());
